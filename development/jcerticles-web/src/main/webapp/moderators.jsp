 ...
 <head>
     ...
     <script type="text/javascript" src="<%=request.getContextPath()%>/js/admin/moderator.js"></script>
     <title>JUG Chennai Moderators</title>
 </head>
     <body>
     <div class="main">
         ...
         <div class="mainContent">
         	 ...
         	 <%@include file="/WEB-INF/pages/admin/moderatorLogIn.jsp" %>
         </div>
         <div class="footer">
